...
execute if score @p[team=neko,scores={target_nekotype_origin=1}] selected_infect matches 1 run function cf:neko/effects/1
execute if score @p[team=neko,scores={target_nekotype_origin=1}] selected_infect matches 2 run function cf:neko/effects/2
execute if score @p[team=neko,scores={target_nekotype_origin=1}] selected_infect matches 3 run function cf:neko/effects/3
execute if score @p[team=neko,scores={target_nekotype_origin=1}] selected_infect matches 4 run function cf:neko/effects/4
execute if score @p[team=neko,scores={target_nekotype_origin=1}] selected_infect matches 5 run function cf:neko/effects/5
