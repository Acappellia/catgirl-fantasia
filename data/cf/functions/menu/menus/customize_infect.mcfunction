...
execute if score @s bp_level matches 12.. run item replace entity @s enderchest.4 with emerald{custom_infect:3,custom_3:1,CustomModelData:32,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"变成丘丘！","color": "gray","italic": false}]'}}
