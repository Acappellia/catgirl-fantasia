...
item replace entity @s enderchest.6 with warped_fungus_on_a_stick{custom_knife:0,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"无近战武器外观","color": "light_gray","italic": false}]'}}
...
execute if score @s bp_level matches 2.. run item replace entity @s enderchest.2 with warped_fungus_on_a_stick{custom_knife:1,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 6.. run item replace entity @s enderchest.3 with warped_fungus_on_a_stick{custom_knife:2,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 10.. run item replace entity @s enderchest.4 with warped_fungus_on_a_stick{custom_knife:3,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 13.. run item replace entity @s enderchest.11 with warped_fungus_on_a_stick{custom_knife:4,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 17.. run item replace entity @s enderchest.12 with warped_fungus_on_a_stick{custom_knife:5,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 20.. run item replace entity @s enderchest.13 with warped_fungus_on_a_stick{custom_knife:6,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 24.. run item replace entity @s enderchest.14 with warped_fungus_on_a_stick{custom_knife:7,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
execute if score @s bp_level matches 27.. run item replace entity @s enderchest.15 with warped_fungus_on_a_stick{custom_knife:8,custom_1:1,CustomModelData:1000,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"外观A","color": "red","italic": false}]'}}
