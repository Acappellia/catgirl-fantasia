...
item modify entity @s enderchest.12 cf:add_humanstat

item replace entity @s enderchest.11 with minecraft:emerald{menu_ui:1,display:{Name:'[{"text":"玩家统计","color": "yellow","italic": false}]'}}
item modify entity @s enderchest.12 cf:add_allstat
...
item modify entity @s enderchest.12 cf:add_nekostat
