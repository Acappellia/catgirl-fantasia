...
execute if score @s bp_level matches 30.. run item replace entity @s enderchest.16 with emerald{custom_helmet:9,custom_2:1,CustomModelData:6,menu_ui:1,HideFlags:63,display:{Name:'[{"text":"十六位武士","color": "red","italic": false}]'}}
