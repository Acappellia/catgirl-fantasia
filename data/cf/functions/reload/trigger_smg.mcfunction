item replace block 0 2 0 container.0 with minecraft:warped_fungus_on_a_stick{CustomModelData:7,cf_gun:1,cf_smg:1}
execute if score @s player_ammo_smg matches ..49 if score @s player_bammo_smg matches 1.. run item replace block 0 2 0 container.0 with minecraft:warped_fungus_on_a_stick{CustomModelData:8,cf_gun_reload:1,cf_smg_reload:1}
