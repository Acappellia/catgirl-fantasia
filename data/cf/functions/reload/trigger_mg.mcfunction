item replace block 0 -62 0 container.0 with minecraft:warped_fungus_on_a_stick{CustomModelData:5,cf_gun:1,cf_mg:1}
execute if score @s player_ammo_mg matches ..199 if score @s player_bammo_mg matches 1.. run item replace block 0 -62 0 container.0 with minecraft:warped_fungus_on_a_stick{CustomModelData:6,cf_gun_reload:1,cf_mg_reload:1}
