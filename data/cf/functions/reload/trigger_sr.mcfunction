...
execute if score @s player_ammo_sr matches ..0 if score @s player_bammo_sr matches 1.. run item replace block 0 -62 0 container.0 with minecraft:warped_fungus_on_a_stick{CustomModelData:10,cf_gun_reload:1,cf_sr_reload:1}
