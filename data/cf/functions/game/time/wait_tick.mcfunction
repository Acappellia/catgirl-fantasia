...
execute if score #player_count cf matches 12.. run function cf:game/time/wait_cd with storage cf:tmp game
execute unless score #player_count cf matches 12.. run function cf:game/time/wait_players with storage cf:tmp game
