...
execute as @e[type=marker,tag=respawn_2] if score @s respawn_rotate = #respawn_rotation cf run tp @a[tag=spawn_tp] @s
tag @s remove spawn_tp
execute at @s anchored eyes positioned ~ ~ ~ facing 10 -50 123 run tp @s ~ ~ ~ ~ ~
