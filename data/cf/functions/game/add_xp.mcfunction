...
scoreboard players operation @s xptoadd_pmelee *= #2000 cf
...
execute if score #game_result cf matches 1 run scoreboard players set @s[team=solder] xptoadd_pwin 5000
