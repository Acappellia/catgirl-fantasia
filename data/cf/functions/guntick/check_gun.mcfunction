execute if data storage cf:tmp SelectedItem.tag.cf_rifle run function cf:guntick/rifle_ammo
execute if data storage cf:tmp SelectedItem.tag.cf_smg run function cf:guntick/smg_ammo
