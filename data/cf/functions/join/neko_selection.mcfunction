...
execute if score @s target_nekotype matches 1 run item replace entity @s hotbar.4 with warped_fungus_on_a_stick{CustomModelData:101,cf_cat_selection:1,cf_cat_1:1}
