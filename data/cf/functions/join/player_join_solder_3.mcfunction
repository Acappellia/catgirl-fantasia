...
give @s warped_fungus_on_a_stick{CustomModelData:7,cf_gun:1,cf_smg:1,display:{Lore:['[{"text": "单发伤害：","color": "gray"},{"text": "9-11","color": "yellow"}]','[{"text": "弹匣容量：","color": "gray"},{"text": "50","color": "yellow"}]','[{"text": "连射速度：","color": "gray"},{"text": "极快","color": "yellow"}]','[{"text": "操控性","color": "gray"},{"text": "中等","color": "yellow"}]','[{"text": "穿透能力","color": "gray"},{"text": "无","color": "yellow"}]'],Name:'[{"text": "恶魔造物 Devil\'s Creation 高速步枪","color": "white","italic": false}]'}}
