...
execute if score #track_pitch_target cf matches -17999..0 store result entity @s Rotation[0] float 0.01 run scoreboard players add #track_pitch_origin cf 1000
