...
#execute if score #give_slots lc_var <= #inv_slots lc_var run loot give @s mine 0 -62 0 stone[custom_data={drop_contents:1}]
#execute if score #give_slots lc_var > #inv_slots lc_var run loot spawn ~ ~ ~ mine 0 -62 0 stone[custom_data={drop_contents:1}]
#setblock 0 -62 0 air
