...
execute if data storage cf:tmp SelectedItem.components."minecraft:custom_data".cf_neko_heal run function cf:skills/heal
execute if data storage cf:tmp SelectedItem.components."minecraft:custom_data".cf_neko_grenade run function cf:skills/grenade/throw
execute unless data storage cf:tmp SelectedItem.components."minecraft:custom_data".cf_pow run return -1
