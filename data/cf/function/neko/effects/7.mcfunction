execute positioned ~ ~0.5 ~ run summon item_display ~ ~ ~ {Tags:["infect_effect"],item:{id:"iron_ingot",count:1,components:{"minecraft:custom_model_data":7}}}
...
particle block{block_state:{Name:"nether_wart_block"}} ~ ~0.5 ~ 0.5 0.5 0.5 0.2 20