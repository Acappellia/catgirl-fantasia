item replace block 0 -62 0 container.0 with minecraft:warped_fungus_on_a_stick[custom_model_data=3,custom_data={cf_gun:1,cf_revolver:1},lore=['[{"text": "单发伤害：","color": "gray"},{"text": "98-110","color": "yellow"}]','[{"text": "弹匣容量：","color": "gray"},{"text": "6","color": "yellow"}]','[{"text": "点射速度：","color": "gray"},{"text": "极快","color": "yellow"}]','[{"text": "操控性","color": "gray"},{"text": "很差","color": "yellow"}]','[{"text": "穿透能力","color": "gray"},{"text": "无","color": "yellow"}]'],custom_name='[{"text": "流浪厄运 Slithering Doom .50 左轮手枪","color": "white","italic": false}]']
execute if score @s player_ammo_revolver matches ..5 if score @s player_bammo_revolver matches 1.. run item replace block 0 -62 0 container.0 with minecraft:warped_fungus_on_a_stick[custom_model_data=4,custom_data={cf_gun_reload:1,cf_revolver_reload:1},lore=['[{"text": "单发伤害：","color": "gray"},{"text": "98-110","color": "yellow"}]','[{"text": "弹匣容量：","color": "gray"},{"text": "6","color": "yellow"}]','[{"text": "点射速度：","color": "gray"},{"text": "极快","color": "yellow"}]','[{"text": "操控性","color": "gray"},{"text": "很差","color": "yellow"}]','[{"text": "穿透能力","color": "gray"},{"text": "无","color": "yellow"}]'],custom_name='[{"text": "流浪厄运 Slithering Doom .50 左轮手枪","color": "white","italic": false}]']
