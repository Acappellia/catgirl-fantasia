item replace entity @s weapon.mainhand with warped_fungus_on_a_stick[custom_model_data=9,custom_data={cf_gun:1,cf_sr:1},lore=['[{"text": "单发伤害：","color": "gray"},{"text": "480-520","color": "yellow"}]','[{"text": "弹匣容量：","color": "gray"},{"text": "2","color": "yellow"}]','[{"text": "连射速度：","color": "gray"},{"text": "极慢","color": "yellow"}]','[{"text": "操控性","color": "gray"},{"text": "中等","color": "yellow"}]','[{"text": "穿透能力","color": "gray"},{"text": "极佳","color": "yellow"}]'],custom_name='[{"text": "观鸟者 Bird Watcher 爆能发射器","color": "white","italic": false}]']
