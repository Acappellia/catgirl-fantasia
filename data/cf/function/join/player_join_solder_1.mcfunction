...
give @s warped_fungus_on_a_stick[custom_model_data=1,custom_data={cf_gun:1,cf_rifle:1},lore=['[{"text": "单发伤害：","color": "gray"},{"text": "21-23","color": "yellow"}]','[{"text": "弹匣容量：","color": "gray"},{"text": "35","color": "yellow"}]','[{"text": "连射速度：","color": "gray"},{"text": "中等","color": "yellow"}]','[{"text": "操控性","color": "gray"},{"text": "极好","color": "yellow"}]','[{"text": "穿透能力","color": "gray"},{"text": "中等","color": "yellow"}]'],custom_name='[{"text": "巨兽 Behemoth .65 爆弹枪","color": "white","italic": false}]']
