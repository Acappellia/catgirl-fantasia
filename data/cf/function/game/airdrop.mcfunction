...
execute if score #active_map cf matches 3 as @e[type=marker,tag=airdrop_3,limit=2,sort=random] at @s run function cf:game/summon_airdrop
execute if score #active_map cf matches 4 as @e[type=marker,tag=airdrop_4,limit=2,sort=random] at @s run function cf:game/summon_airdrop
