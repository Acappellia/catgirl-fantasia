...
particle block{block_state:{Name:"nether_wart_block"}} ~ ~ ~ 0.2 0.2 0.2 0.1 30
particle block{block_state:{Name:"lava"}} ~ ~ ~ 0.2 0.2 0.2 0.1 20
particle dust{color:[232,74,74],scale:3} ~ ~3 ~ 0 2 0 0 100
