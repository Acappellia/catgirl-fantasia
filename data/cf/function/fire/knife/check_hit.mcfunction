...
execute at @s anchored eyes facing entity @a[distance=..4,tag=atking] eyes positioned ^ ^ ^ store result score #neko_hit_success cf run function cf:fire/knife/check_hit_ray
...
execute at @s run particle block{block_state:{Name:"nether_wart_block"}} ~ ~1 ~ 0.3 0.3 0.3 0.1 5
