...
item replace entity @s weapon.mainhand with warped_fungus_on_a_stick[custom_data={cf_pow:1},custom_model_data=101,hide_additional_tooltip={},custom_name='[{"text": "猫爪"}]']
